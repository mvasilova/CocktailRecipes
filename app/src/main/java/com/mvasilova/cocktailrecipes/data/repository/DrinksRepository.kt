...
class DrinksRepositoryImp(private val api: Api, private val favoriteDao: FavoriteDao) :
    DrinksRepository {
    ...
    override fun getSearchByNameList(nameDrink: String): Single<DrinksFilter> =
        api.getSearchByNameList(nameDrink)
            .observeMainThread()
